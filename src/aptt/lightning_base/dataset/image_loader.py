...
class ImageLoader(BaseDataLoader):
    def __init__(
        self, batch_size: int = 32, num_workers: int = 4, randaugment: bool = False, image_size: tuple = (256, 256)
    ):
        ...
        if self.randaugment:
            ...
            return A.Compose(
                [
                    ...
                    A.CoarseDropout(
                        num_holes_range=(0, 1), hole_height_range=(5, 32), hole_width_range=(5, 32), fill=0, p=0.5
                    ),
