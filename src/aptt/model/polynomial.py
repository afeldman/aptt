...
Beispiel:
    >>> import torch
    >>> from aptt.layers.polynomial_net import PolynomialNet
...
class PolynomialCartesian2Polar(nn.Module):
    ...
    Examples:
        >>> import torch
        >>> from aptt.layers.polynomial_polar import PolynomialCartesian2Polar
...
class PolynomialPolar2Cartesian(nn.Module):
    ...
    Examples:
        >>> import torch
        >>> from aptt.layers.polynomial_polar import PolynomialPolar2Cartesian
