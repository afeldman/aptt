...
Modell-Architekturen für verschiedene Deep Learning Tasks.
...
- **`detection/`**
  ...
  - `detection.py` - Basis Detection-Architektur
  - `efficient.py` - EfficientDet
  - `darknet.py` - DarkNet Backbone
  - `resnet.py` - ResNet Detection
  - `mobile.py` - MobileNet-basierte Detectors
...
```python
from aptt.model import DeepSeekV3
...
```python
from aptt.model.detection import YOLO
...
```python
from aptt.model.detection import CenterNet
...
```python
from aptt.model.feature import ResNet50
...
```python
from aptt.model.feature import FPN
...
```python
from aptt.model.beamforming import Beamformer
...
```python
from aptt.model import DOAEstimator
...
- ✅ Einfacher Export (ONNX, TorchScript, TensorRT)
- ✅ Batch Inference Support
- ✅ Mixed Precision (FP16/BF16)
- ✅ Modular Design für Custom Heads

### Export Beispiel

```python
from aptt.model import ResNet50
from aptt.model.backend_adapter import ONNXAdapter, TensorRTAdapter
