...
Example:
    >>> import torch
    >>> from deepsuite.loss import SegmentationLoss
    >>> model = torch.nn.Module()
    >>> criterion = SegmentationLoss(model)
    >>> preds = torch.randn(2, 3)
    >>> batch = {
    ...     "batch_idx": torch.randint(0, 2, (2, 1)),
    ...     "cls": torch.randint(0, 2, (2, 1)),
    ...     "bboxes": torch.randn(2, 4),
    ...     "masks": torch.randn(2, 80, 80),
    ... }
...
from deepsuite.utils.image import crop_mask
