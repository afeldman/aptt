...
class AudioBeamformingPipeline:
    ...
    def __init__(
        ...
        print("🎙️  Audio Beamforming Configuration")
        ...
        self.das_beamformer = DelayAndSumBeamformer(
            mic_positions=self.mic_positions, sample_rate=sample_rate
        ).to(self.device)
    ...
    def beamform_audio(
        self, audio: np.ndarray, target_angle: float, method: str = "das"
    ) -> np.ndarray:
    ...
    def _find_peaks(
        self, spectrum: np.ndarray, angles: np.ndarray, n_peaks: int = 3
...
def main():
    ...
    parser.add_argument(
        "--input", type=str, required=True, help="Input audio file (multi-channel WAV)"
    )
    parser.add_argument("--output", type=str, default="./output", help="Output directory")
    parser.add_argument("--n-mics", type=int, default=8, help="Number of microphones")
    parser.add_argument("--array-radius", type=float, default=0.1, help="Array radius in meters")
    parser.add_argument(
        "--array-type",
        type=str,
        default="circular",
    ...
    parser.add_argument(
        "--angle", type=float, default=0.0, help="Target angle for beamforming (degrees)"
    )
    parser.add_argument(
        "--method", type=str, default="das", choices=["das", "music"], help="Beamforming method"
    )
    parser.add_argument(
