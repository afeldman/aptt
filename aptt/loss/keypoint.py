"""
This module contains the KeypointLoss class for computing training losses.
...
Example:
    >>> import torch
    >>> from aptt.loss import KeypointLoss
...
class KeypointLoss(nn.Module):
    ...
    def forward(self, pred_kpts: torch.Tensor, gt_kpts: torch.Tensor,
                kpt_mask: torch.Tensor, area: float) -> torch.Tensor:
        ...
        return (kpt_loss_factor.view(-1, 1) *
                ((1 - torch.exp(-e)) * kpt_mask)).mean()
